...
UUID=${UUID:-'78a34f0d-63ed-4750-a37a-16ca8809a5c9'}
VMESS_WSPATH=${VMESS_WSPATH:-'/vmsh'}
VLESS_WSPATH=${VLESS_WSPATH:-'/vlsh'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/trsh'}
SS_WSPATH=${SS_WSPATH:-'/shsh'}
